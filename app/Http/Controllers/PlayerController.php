...
class PlayerController extends Controller
{
     ...
     *             @OA\Property(property="sexo", type="string", enum={"masculino","feminino","prefiro_nao_informar"}, nullable=true, example="masculino"),
    ...
    public function store(Request $request)
    {
        ...
        $data = $request->validate([
            ...
            "sexo" => 'nullable|in:masculino,feminino,prefiro_nao_informar',
            ...
            'level.min' => 'A categoria do jogador deve ser entre 1 e 7.',
            'level.max' => 'A categoria do jogador deve ser entre 1 e 7.',
            'side.required' => 'O lado do jogador é obrigatório.',
            'sexo.in' => 'O sexo deve ser masculino, feminino ou prefiro_nao_informar.',
